# Next Steps for ndx-icephys-units Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-icephys-units directory.
...
4. Modify `src/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-icephys-units` - Folder with the sources of the NWB extension
        - `ndx-icephys-units/__init__.py` - Python file that may be empty
...
`spec/ndx-icephys-units.namespace.yaml` and
`spec/ndx-icephys-units.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-icephys-units
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/rly/ndx-icephys-units/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on PyPi.
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-icephys-units/0.1.0
...
`staged-extensions/ndx-icephys-units`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-icephys-units
    ```

13. Edit `staged-extensions/ndx-icephys-units/ndx-meta.yaml`
...
version: 0.1.0
src: https://github.com/rly/ndx-icephys-units
pip: https://pypi.org/project/ndx-icephys-units/
license: BSD 3-Clause
maintainers:
  - rly
```

14. Edit `staged-extensions/ndx-icephys-units/README.md`
to add information about your extension. You may copy it from
`ndx-icephys-units/README.md`.

  ```bash
cp ndx-icephys-units/README.md staged-extensions/ndx-icephys-units/README.md
```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-icephys-units
git commit -m "Add new catalog entry for ndx-icephys-units" .
git push
```
...
ndx-icephys-units-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-icephys-units GitHub repository.

2. Publish your updated extension on PyPi.

3. Fork the ndx-icephys-units-feedstock repository on GitHub.
